  ...
  return (
    <div className="flex gap-2 pb-2 pr-2 font-semibold text-gray-700">
      ...
      <button
        ...
        className="flex-1 hidden md:block text-left cursor-pointer hover:brightness-150 transition-all"
      >
        {isShowSummary ? "About" : "Built with"}{" "}
        <ArrowLeftRight stroke="currentColor" width="1em" className="inline" />{" "}
